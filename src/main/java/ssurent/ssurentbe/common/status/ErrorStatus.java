...
public enum ErrorStatus implements BaseStatus {
    ...
    CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "CATEGORY404", "찾을 수 없는 카테고리입니다."),
    ITEM_NOT_FOUND(HttpStatus.NOT_FOUND,"ITEM404","아이템을 찾을 수 없습니다."),
    DUPLICATE_ITEM(HttpStatus.CONFLICT, "CATEGORY409", "이미 존재하는 아이템 이름과 번호입니다"),
    /**
     * Auth
     */
